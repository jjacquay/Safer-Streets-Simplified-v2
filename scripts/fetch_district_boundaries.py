...
def render_report(results, log, recompute_out):
    lines = [
        ...
        "validated hard (exact feature count, one in-range district per feature)",
        "but the chosen layers still deserve a human look before the",
        "corridor_districts they produce ships to residents._",
        "",
    ]
